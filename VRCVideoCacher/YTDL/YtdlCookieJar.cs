...
/// run in two stages: short metadata extraction through this gate (which saves info JSON and refreshes
/// the cookie jar), followed by media chunk download with <c>--load-info-json</c> without cookies,
/// avoiding holding this gate and allowing playback and URL resolution requests to proceed concurrently.
/// </summary>
